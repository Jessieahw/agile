...
def test_nba_private_share_player_comp_visibility(driver, live_server):
    ...
    # fill the team-match form quickly
    driver.find_element(By.ID, "pts").send_keys("10")
    driver.find_element(By.ID, "ast").send_keys("10")
    driver.find_element(By.ID, "stl").send_keys("10")
    driver.find_element(By.ID, "blk").send_keys("10")
    driver.find_element(By.ID, "trb").send_keys("10")
    driver.find_element(By.CSS_SELECTOR, "button[type='submit']").click()
...
def test_bbl_private_radar_graph_visibility(driver, live_server):
    ...
    driver.find_element(By.CSS_SELECTOR, "button[type='submit']").click()
    WebDriverWait(driver, 5).until(
        expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "div[class='similar-results-flex']"))
    )

    # Click to go to Stats & You page:
    driver.find_element(By.ID, "statsbtn").click()
    WebDriverWait(driver, 5).until(
    ...
    driver.find_element(By.ID, "share-text").send_keys("Sekrit Message...")
